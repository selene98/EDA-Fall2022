...
> Answer: 
H0: mu >= 50  #which way to define is okay
Ha: mu < 50
...
O3.onesample
#"alternative is the Ha, reject the null Ho
...
# Format as a GLM
O3.onesample2 <- lm(Ozone ~ 1, EPAair) #1 means no interrelated variable; only one
O3.onesample2
```
...
Ho: mean 2018 = mean 2019
Ha: mean 2018 != mean 2019
```{r}
...
#"EPAair$Ozone ~ EPAair$Year" could be changed to "Ozone ~ Year, EPAair"
