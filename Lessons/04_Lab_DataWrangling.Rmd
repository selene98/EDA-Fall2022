...
#This code chunk will tidy your knit PDF files, wrapping long code lines to avoid code knitted out of the page!!
#For it to work, the "formatR" package needs to be installed

#install.packages('formatR')
#!!always add '#' to the install command because it wiill cause panis when knit out file.
...
NTL.phys.data.from1990to1999 <- filter(NTL.phys.data.Tuesday, year4 %in% c(1990:1999))
NTL.phys.data.from1990to1999
...
month(NTL.phys.data$sampledate)
Ex3<-
  NTL.phys.data %>%
