...
* **Correlation**: a measure of linear dependence between two variables.
* **Autocorrelation**: a measure of dependence between two adjacent values of the same variables. Data points are not independent from one another (i.e., the measurement at a given time point is dependent on previous time point(s))
