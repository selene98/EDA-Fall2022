...
```{r}
ggplot(Neonics) +
  geom_freqpoly(aes(x = Test.Location), bins = 50, color = "pink")
```
...
> Answer: Data obtained from 'unique' is mostly list different names or value in the specific dataset. 
